...
namespace myTest3_23
{
    class Program
    {
        ...
        private static void TestProblem1452(String fileName,String resultFileName) {
            
            PdfDocument doc = new PdfDocument();
            doc.LoadFromXPS(fileName);
            doc.SaveToFile(resultFileName, FileFormat.PDF);
        ...
        static void Main(string[] args)
        {
            ...
            TestProblem1452(@"D:\adonai\1452\input_file.xps", "result.pdf");
            //TestVertical2();
           // TestDrawBlack();
        }
    }
